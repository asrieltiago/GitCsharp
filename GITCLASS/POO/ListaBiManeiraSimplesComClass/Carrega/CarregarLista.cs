...
namespace ListaBiManeiraSimplesComClass.Carrega
{
    class CarregarLista
    {
        ...
        {
            //Assinamos nossa lista no metodo construtor, com isso deixamos a lista pronta para uso
            //nos demais metodos sem precisar de um parametro para isso
